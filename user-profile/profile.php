...
else if ($action == "delete")   { include "delete_acc.php"; }
else 
{
?>
...
<body>
    <div class="main-container flex-container">
        <div class="account-container flex-container flex-col flex-start">
            ...
            <a class="fs-ps" href="user.php?menu=profile&action=logout">Log Out</a>
            <div>
            ...
            $link_edit  = "user.php?menu=profile&action=edit&id=$rows[account_id]";
            $link_delete  = "user.php?menu=profile&action=delete&id=$rows[account_id]";
            ?>
            <table class="profile-container">
                ...
                <tr>
                    <td colspan="2">
                    <a onclick="return confirm('Apakah anda yakin ingin menghapus akun anda?')" id="del-confirm" style="text-decoration: none;" name="del-confirm" href="<?=$link_delete;?>">Delete Account</a>
                    </td>
                </tr>
            </table> 
        </div>
